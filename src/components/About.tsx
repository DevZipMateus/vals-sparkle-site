...
const About = () => {
  ...
  return (
    <section id="sobre" className="py-20 bg-gradient-to-br from-nature-50 to-white">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <div>
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-nature-600 to-nature-400 rounded-full mb-6"></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div className="text-center p-4 bg-white/60 backdrop-blur-sm rounded-lg border border-nature-200">
          ...
          <div className="space-y-8 animate-slide-in">
            ...
            <Card className="border-nature-200 card-hover">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  <div className="bg-nature-100 p-3 rounded-lg">
                    <Target className="h-6 w-6 text-primary" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-3 text-foreground">Nossa Missão</h3>
            ...
            <Card className="border-nature-200 card-hover">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3 text-foreground">Nossa Visão</h3>
                    <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="border-nature-200 card-hover">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4 text-foreground">Nossos Valores</h3>
                <div className="grid grid-cols-2 gap-4">
                  {values.map((value, index) => (
                    <div key={index} className="text-center p-3 bg-nature-50 rounded-lg">
                      <div className="mb-2 flex justify-center">
                        {value.icon}
                      </div>
                      <h4 className="font-semibold text-sm text-foreground mb-1">{value.title}</h4>
